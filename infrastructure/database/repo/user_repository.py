...
from infrastructure.database.models import User, BookInnerInfoModel
...
class UserRepo(BaseRepo):
    ...
    async def proceed_user_download_book(self, user_id: int, book_id: int, file_id: str, file_format: str) -> None:
        ...
        """
        query = select(BookInnerInfoModel).options(
            selectinload(BookInnerInfoModel.downloaded_by)
